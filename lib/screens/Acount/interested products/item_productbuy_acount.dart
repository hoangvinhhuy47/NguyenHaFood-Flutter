...
class item_product_buy_acount extends StatefulWidget {
  const item_product_buy_acount({Key key, this.product}) : super(key: key);

  State<item_product_buy_acount> createState() => _item_product_buy_acount();
  final ProductBuyList product;
}

class _item_product_buy_acount extends State<item_product_buy_acount> {
  @override
