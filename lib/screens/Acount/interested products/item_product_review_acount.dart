...
class item_product_review_acount extends StatefulWidget {
  const item_product_review_acount({Key key, this.product}) : super(key: key);

  State<item_product_review_acount> createState() => _item_product_review_acount();
  final ProductReviewList product;
}

class _item_product_review_acount extends State<item_product_review_acount> {
  @override
