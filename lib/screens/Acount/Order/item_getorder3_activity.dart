...
class item_getorder4_activity extends StatefulWidget {
  const item_getorder4_activity({Key key, this.orderList}) : super(key: key);

  State<item_getorder4_activity> createState() => _item_getorder4_acitivity();
  final OrderList orderList;
}

class _item_getorder4_acitivity extends State<item_getorder4_activity> {
  @override
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text('Hoàng Thành',style: TextStyle(color: mauxanhlacay,fontSize: 14,fontWeight: FontWeight.w400),),
                            )
                          ],
                        ),
                      ),
