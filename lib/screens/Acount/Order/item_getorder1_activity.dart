...
import 'package:shop_app/screens/Acount/Order/order_detail_activity.dart';

class item_getorder2_activity extends StatefulWidget {
  const item_getorder2_activity({Key key, this.orderList}) : super(key: key);

  State<item_getorder2_activity> createState() => _item_getorder2_acitivity();
  final OrderList orderList;
}

class _item_getorder2_acitivity extends State<item_getorder2_activity> {
  @override
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text('Đang Vận Chuyển',style: TextStyle(color: maucam,fontSize: 14,fontWeight: FontWeight.w400),),
                            )
                          ],
                        ),
                      ),
