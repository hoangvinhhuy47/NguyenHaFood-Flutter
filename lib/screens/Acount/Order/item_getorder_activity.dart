...
class item_getorder1_activity extends StatefulWidget {
  const item_getorder1_activity({Key key, this.orderList}) : super(key: key);

  State<item_getorder1_activity> createState() => _item_getorder1_acitivity();
  final OrderList orderList;
}

class _item_getorder1_acitivity extends State<item_getorder1_activity> {
  @override
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text('Đang Xử Lí',style: TextStyle(color: maucam,fontSize: 14,fontWeight: FontWeight.w400),),
                            )
                          ],
                        ),
                      ),
